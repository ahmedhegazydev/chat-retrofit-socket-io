	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				other JSON documents and elements of interaction. This allows socketUser agents to be able to successfully navigate
	...
	"links": [{
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				<t>
					...
					interpreted and validated, such that socketUser agents can properly understand
		...
		<section title="Schema/Instance Association">
			<t>
				...
				specify their schema so that socketUser agents can interpret the instance
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			<t>
				...
				purpose of informing socketUser agents of relations between resources based
				...
				Addition of attributes provides additive information for socketUser agents.
			</t>
				...
				<section title="Link Description Object">
					...
					<section title="href">
						<t>
							...
							in the template (otherwise they MAY be provided from alternate sources, like socketUser input).
						</t>
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="root">
									...
									purposes of socketUser agent interaction or fragment resolution. All other
	...
	"upId": "parent"
					...
					<section title="Submission Link Properties">
						<t>
							...
							means for submitting extra (often socketUser supplied) information to send to a server.
						</t>
...
#/foo/anArray/0          the first object in the "anArray" array
			...
			<section title="readonly">
				<t>This attribute indicates that the instance property SHOULD NOT be changed. Attempts by a socketUser agent to modify the value of this property are expected to be rejected by a server.</t>
			</section>
			...
			<section title="pathStart">
				...
				<t>
					When multiple schemas have been referenced for an instance, the socketUser agent
		...
		<section title="Security Considerations">
			<t>
				...
				is used to denote a full representation of an object, the socketUser agent
...
[{
	...
	"name": "This representation should not be treated as \
		authoritative the socketUser agent should make request the resource\
